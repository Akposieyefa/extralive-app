                        ...
                        <div class="mb-npx">
                            <div class="row align-items-center">
                                <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                                    <!-- Title -->
                                    <h1 class="h2 mb-0 ls-tight">Treatment Tye</h1>
                                </div>
                                <!-- Actions -->
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow border-0 mb-7">
                            <div class="card-header">
                                <h5 class="mb-0">All Treatment Types</h5>
                            </div>
...
export default {
    ...
    methods: {
        ...
        async editMode(id) {
            this.edit = true;
            let api_url = process.env.MIX_API_BASE_URL + "treatment-types/";
        ...
        async getAllTypes() {
            ...
            let api_url =
                ...
                `treatment-types?page=${vm.types.meta.current_page}`;
            await axios
                .get(api_url, {
