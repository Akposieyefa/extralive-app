        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                api_url = "https://extralive.herokuapp.com/api/v1/" + 'get-dashboard';
                _context.next = 3;
              ...
              case 3:
                ...
                _this.services = response.data.data.services;
                _this.enrolled_users = response.data.data.enrolled_users;
                _this.agents = response.data.data.agents;
          ...
          _c("div", { staticClass: "row" }, [
            _c("div", { staticClass: "col" }, [
              _c(
                ...
                [_vm._v(" Enrolled Users")]
              ),
              _vm._v(" "),
              _c("span", { staticClass: "h3 font-bold mb-0" }, [
                _vm._v(_vm._s(_vm.enrolled_users)),
              ]),
            ]),
            _vm._v(" "),
            _vm._m(1),
