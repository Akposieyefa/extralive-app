        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                api_url = "https://extralive.herokuapp.com/api/v1/" + "login";
                _context.prev = 3;
                _this.loading = true;
                _context.next = 7;
              ...
              case 7:
                ...
                _context.next = 11;
                return _this.$store.dispatch("user", response.data.data);
          ...
          _c(
            ...
            [
              _c("router-link", { attrs: { to: "/", href: "#" } }, [
                _c("img", {
                  staticClass: "img-responsive center-block d-block mx-auto",
                  attrs: {
